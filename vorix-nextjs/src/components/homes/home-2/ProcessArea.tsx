          ...
          <div className="row g-3 justify-content-center">
            <div className="col-12 col-lg-6">
              <div className="section-heading text-center">
                <h2 className="mb-0">Simple Notre Parcours<br />d’écoute</h2>
              </div>
            </div>
          </div>
          ...
          <div className="row g-4">
              ...
              <div className="process-card-two">
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
                  <g clipPath="url(#clip0_1_751)">
                    <path d="M35.3906 0H6.44531C2.89137 0 0 2.89137 0 6.44531V9.375H35.3906V0Z" fill="#6D28D9" />
                ...
                <h4>Découvrir</h4>
                <p className="mb-0">Parcourez les playlists et trouvez la musique parfaite.</p>
              </div>
            </div>
              ...
              <div className="process-card-two">
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
                  ...
                  <path
                    ...
                    fill="#6D28D9" />
                  <path d="M23.5713 8.57227H28.9284V27.858H23.5713V8.57227Z" fill="#6D28D9" />
                  <path d="M31.0713 8.57227H36.4284V27.858H31.0713V8.57227Z" fill="#6D28D9" />
                  <path
                ...
                <h4>Écouter</h4>
                <p className="mb-0">Lancez la lecture, ajustez le volume et profitez du son.</p>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="process-card-two">
                ...
                <h4>Partager</h4>
                <p className="mb-0">Ajoutez aux favoris et partagez vos playlists avec vos amis.</p>
              </div>
            </div>
          </div>
        </div>
