          ...
          <div className="row g-5 align-items-end justify-content-between">
            <div className="col-12 col-md-6 col-lg-5">
              <div className="section-heading">
                <h2 className="mb-0">Playlists mises en avant</h2>
              </div>
            </div>
            ...
            className="swiper portfolio-swiper">           
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="portfolio-card-two">
                    <LazyImage src="https://images.pexels.com/photos/164879/pexels-photo-164879.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Playlist focus" />
                  ...
                  <div className="portfolio-content-two">
                    <h3>Focus & Study</h3>
                    <p className="mb-0">LoFi • Chillhop</p>
                  </div>
                </SwiperSlide>

                <SwiperSlide className="swiper-slide">
                  <div className="portfolio-card-two">
                    <LazyImage src="https://images.pexels.com/photos/408799/pexels-photo-408799.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Playlist guitare" />
                  ...
                  <div className="portfolio-content-two">
                    <h3>Acoustic & Indie</h3>
                    <p className="mb-0">Unplugged • Soft</p>
                  </div>
                </SwiperSlide>
