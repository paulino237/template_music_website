          ...
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section-heading text-center">
                <h2 className="mb-0">Fonctionnalités musicales</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <Swiper
            ...
            <SwiperSlide className="swiper-slide">
              <Link href="/service-details" >
                ...
                <h2>Lecteur audio</h2>
                <p className="mb-0">Lecture, pause, précédent/suivant et barre de progression intuitive.</p>
              </Link>
            ...
            <SwiperSlide className="swiper-slide">
              <Link href="/service-details" >
                ...
                <h2>Playlists</h2>
                <p className="mb-0">Créez, gérez et lancez vos listes de lecture favorites.</p>
              </Link>
            ...
            <SwiperSlide className="swiper-slide">
              <Link href="/service-details" >
                ...
                <h2>Favoris</h2>
                <p className="mb-0">Ajoutez des morceaux aux favoris pour les retrouver rapidement.</p>
              </Link>
            ...
            <SwiperSlide className="swiper-slide">
              <Link href="/service-details" >
                ...
                <p className="mb-0">Réglez précisément le volume pour une écoute parfaite.</p>
              </Link>
            ...
            <SwiperSlide className="swiper-slide">
              <Link href="/service-details" >
                ...
                <h2>Partage</h2>
                <p className="mb-0">Diffusez vos playlists à vos amis en un clic.</p>
              </Link>
