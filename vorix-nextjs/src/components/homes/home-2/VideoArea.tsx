...
const counter_data = [
  {
    count: 10,
    label: "Années d’expérience musicale",
    description: "Des playlists soignées et une lecture fluide pour tous les styles.",
  },
  {
    count: 1200,
    label: "Playlists actives",
    description: "Des sélections mises à jour régulièrement, adaptées à chaque moment.",
  },
  {
    count: 50000,
    label: "Auditeurs satisfaits",
    description: "Une communauté grandissante qui écoute et partage au quotidien.",
  }
];
