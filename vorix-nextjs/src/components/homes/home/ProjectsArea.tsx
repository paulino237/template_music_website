          ...
          <div className="row g-4 align-items-end justify-content-between">
            <div className="col-12 col-md-6 col-lg-5">
              <div className="section-heading">
                <h2 className="mb-0">Découvrez nos playlists</h2>
              </div>
            </div>

            <div className="col-12 col-md-6 col-lg-4">
              <div className="text-md-end">
                <a href="#" className="btn btn-primary"><span>VOIR PLUS</span><span>VOIR PLUS</span></a>
              </div>
            </div>
          </div>
          ...
          <div className="row g-4 g-xl-5">
            ...
            <div className="col-md-6">
              <div className="portfolio-card">
                <LazyImage src="https://images.pexels.com/photos/210922/pexels-photo-210922.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Playlist rock" />


                <div className="portfolio-overlay-content d-flex align-items-center justify-content-between">
                  <div className="me-4">
                    <h3 className="mb-0">Rock Essentials</h3>
                    <p className="mb-0">50 titres incontournables</p>
                  </div>
            ...
            <div className="col-md-6">
              <div className="portfolio-card">
                <LazyImage src="https://images.pexels.com/photos/164879/pexels-photo-164879.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Playlist chill" />


                <div className="portfolio-overlay-content d-flex align-items-center justify-content-between">
                  <div className="me-4">
                    <h3 className="mb-0">Chill & LoFi</h3>
                    <p className="mb-0">Concentration et détente</p>
                  </div>
            ...
            <div className="col-md-6">
              <div className="portfolio-card">
                <LazyImage src="https://images.pexels.com/photos/164716/pexels-photo-164716.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Playlist EDM" />


                <div className="portfolio-overlay-content d-flex align-items-center justify-content-between">
                  <div className="me-4">
                    <h3 className="mb-0">EDM Party</h3>
                    <p className="mb-0">Énergie et beats</p>
                  </div>
            ...
            <div className="col-md-6">
              <div className="portfolio-card">
                <LazyImage src="https://images.pexels.com/photos/408799/pexels-photo-408799.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Playlist acoustique" />


                <div className="portfolio-overlay-content d-flex align-items-center justify-content-between">
                  <div className="me-4">
                    <h3 className="mb-0">Acoustic Sessions</h3>
                    <p className="mb-0">Ambiance intime</p>
                  </div>
