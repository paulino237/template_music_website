...
const services = [
  { icon: "music_note", title: "Lecteur audio avancé", description: "Lecture, pause, précédent/suivant et barre de progression intuitive." },
  { icon: "queue_music", title: "Playlists", description: "Créez, gérez et lancez vos listes de lecture favorites." },
  { icon: "favorite", title: "Favoris", description: "Ajoutez des morceaux à vos favoris pour les retrouver rapidement." },
  { icon: "volume_up", title: "Contrôle du volume", description: "Réglez précisément le volume pour une écoute parfaite." },
  { icon: "graphic_eq", title: "Visuels immersifs", description: "Covers haute qualité pour un rendu moderne et immersif." },
  { icon: "download", title: "Hors connexion (à venir)", description: "Téléchargez des morceaux pour les écouter sans réseau." },
  { icon: "share", title: "Partage", description: "Partagez vos playlists avec vos amis en un clic." },
  { icon: "security", title: "Fiabilité", description: "Audio stable et performant sur tous les appareils." },
];
          ...
          <div className="row g-4 align-items-end">
            <div className="col-12 col-sm-6">
              <div className="section-heading">
                <h2 className="mb-0">Fonctionnalités pour les mélomanes</h2>
              </div>
            </div>
