  ...
  return (
    <>
      <div className="testimonial-contact-wrapper">
          ...
          <div className="row">
            <div className="col-12 col-lg-6">
              <div className="section-heading">
                <h2 className="mb-0">Avis des auditeurs</h2>
              </div>
              ...
              <svg className="mb-3" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60"
                ...
                className="swiper testimonial-swiper">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <p>“Une écoute fluide et des playlists inspirantes. Le player est simple et super réactif !”</p>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <p>“J’adore les visuels d’albums en haute qualité et le contrôle du volume précis.”</p>
                      <div className="border-line"></div>
                      <div className="testimonial-info d-flex align-items-center">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <p>“Parfait pour travailler en musique : la playlist LoFi est top et sans coupures.”</p>
                      <div className="border-line"></div>
                      <div className="testimonial-info d-flex align-items-center">
        ...
        <div className="contact-wrapper" style={{ backgroundImage: 'url(https://images.pexels.com/photos/1010519/pexels-photo-1010519.jpeg)' }}>
